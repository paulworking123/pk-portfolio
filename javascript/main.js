            ...
            $.ajax({
                ...
                .fail(function (data) {
                    ...
                    if (data.responseText !== "") {
                        $(formMessages).html(
                            '<div class="mb-5 alert mb-0 alert-danger" role="alert">' +
                            message +
                            "</div>"
                        );
                    } else {
                        $(formMessages).html(
                            '<div class="mb-5 alert mb-0 alert-danger" role="alert">Oops! An error occured and your message could not be sent.</div>'
                        );
                    }
                });
        });
